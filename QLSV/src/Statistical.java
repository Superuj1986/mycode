...
public class Statistical extends JFrame {
    ...
    String[] tbl1 = {"Họ và tên", "Mã SV", "Mã Lớp", "Khoa", "Ngành", "Tên ĐT", "Mã số ĐT", "TGTH", "Tiến Độ", "GVHD", "Kinh phí"};

    Vector vttitlecbv = new Vector();
    Vector vtdatacbv = new Vector();
    String[] tbl2 = {"Họ và tên", "Mã SV", "Mã Lớp", "Khoa", "Ngành", "Tên ĐT", "Mã số ĐT", "TGTH", "Tiến Độ", "GVHD", "Kinh phí"};
    ...
    //cho dữ liệu vào danh sách đã bảo vệ
    public void load() {
        try {
